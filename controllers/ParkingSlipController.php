...
class ParkingSlipController extends BaseAdminController
{
    ...
    /**
     * Displays a single ParkingSlip model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new ParkingSlip model.
    ...
    /**
     * Updates an existing ParkingSlip model.
    ...
    /**
     * Deletes an existing ParkingSlip model.
    ...
    /**
     * Finds the ParkingSlip model based on its primary key value.
    ...
    {
        if (($model = ParkingSlip::findOne($id)) !== null) {
            return $model;
        }
