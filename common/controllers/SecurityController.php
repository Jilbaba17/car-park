...
//             		Yii::$app->authManager->getRolesByUser(Yii::$app->user->getId()) == "USER") {
//             	throw new HttpException('403');
//             }
                if(\Yii::$app->id == 'app-frontend' && \Yii::$app->user->can('GUARD')) {
                    \Yii::$app->user->logout();
                    \Yii::$app->session->setflash('warning', 'You will now be re-directed to the login page for administrators');
